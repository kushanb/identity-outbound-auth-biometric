...
export class Authorization {
    ...
    static processAuthRequest(request) {
        ...
        if (request.data.deviceId &&
            ...
            authRequest = {
                ...
                authUrl: "https://192.168.1.112:9443/biometric-auth?initiator=mobile" +
                    "&sessionDataKey=" +
                    request.data.sessionDataKey +
                    "&challenge=" +
                    request.data.challenge,
                privateKey: "-----BEGIN PRIVATE KEY-----\r\n" +
                    ...
                    "M+ixVx2iE3n25B0=\r\n" +
                    "-----END PRIVATE KEY-----",
                connectionCode: (request.data.sessionDataKey.substring(0, 4) +
                    " - " +
                    request.data.sessionDataKey.substring(4, 8)).toUpperCase(),
            };
        }
        else {
     ...
     */
    getRequestExpiryTime(requestInitTime) {
     ...
     */
    static sendAuthRequest(authRequest, response) {
        console.log("challenge: " + authRequest.challenge);
        let signature = Crypto.signChallenge(authRequest.privateKey, authRequest.challenge);
        let headers = {
