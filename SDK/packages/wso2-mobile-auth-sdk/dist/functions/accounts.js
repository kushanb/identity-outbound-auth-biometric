...
export class Accounts {
    ...
    addAccount(regRequest) {
        ...
        let signedChallenege = Crypto.signChallenge(keypair.prvKey, regRequest.challenge);
        let request;
        request = {
            id: discoveryData.id,
            pushID: "fQrUKjM_TyWc2w4QrK8vyB:APA91bFsNHubZZJJnhrxD_VGz0zVnepwfL1PTxxOzPGu-qk6g3qbgfbNT8AsXBjPlrt3Rpc5OF94wnIJs2Iu_AksVNs4Ii8qMhOVETeBE3EEMfz3_Ou0Y2bJ5gyTboIpSI3e5Ugd98WX",
        ...
        let newRequest = new RequestSender();
        newRequest.sendRequest(discoveryData.registrationUrl, requestMethod, headers, JSON.stringify(regRequestBody));
    }
    /**
     ...
     */
    removeAccount(accountID, privateKey) {
     ...
     */
    processDiscoveryData(regRequest) {
     ...
     */
    sendEnrolementRequest(request) {
        // TODO: change to url from discovery data
        console.log("Send enrolement request function");
        fetch("https://192.168.1.112:9443/t/carbon.super/api/users/v1/me/biometricdevice", {
            method: "POST",
